...
<body>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card o-hidden border-0 shadow-lg my-5 mx-auto" style="width: 600px; height: 600px;">
                            ...
                            <div class="col-md-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        <img src="img/bobapeer-03.png" alt="Sign Up" class="mb-4" style="height: 40%; width: 40%;">
